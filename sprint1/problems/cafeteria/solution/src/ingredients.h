...
class Bread : public std::enable_shared_from_this<Bread> {
  public:
    ...
    // Начинает приготовление хлеба на газовой плите. Как только горелка будет
    // занята, вызовет handler
    ...
    // Возвращает продолжительность выпекания хлеба. Бросает исключение, если
    // хлеб не был испечён
